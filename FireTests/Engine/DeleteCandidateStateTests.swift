...
struct DeleteCandidateStateTests {
    @Test func shouldEnter_withCtrlShiftDigit() {
        ...
        #expect(DeleteCandidateState.shouldEnter(Key.ctrlShiftDigit(2), context: context, shortcut: .defaultDeleteCandidate))
    }
    ...
    @Test func shouldEnter_rejectsPlaceholderCandidate() {
        ...
        #expect(!DeleteCandidateState.shouldEnter(Key.ctrlShiftDigit(1), context: context, shortcut: .defaultDeleteCandidate))
    }
