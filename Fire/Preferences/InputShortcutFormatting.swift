...
extension InputShortcut {
    init(keyCode: UInt16, modifiers: NSEvent.ModifierFlags) {
        self.init(
            keyCode: keyCode,
            modifiers: modifiers.intersection(.deviceIndependentFlagsMask).rawValue
        )
    }
...
extension DigitInputShortcut {
    init(modifiers: NSEvent.ModifierFlags) {
        self.init(modifiers: modifiers.intersection(.deviceIndependentFlagsMask).rawValue)
    }
...
extension InputShortcut: Defaults.Serializable {}
extension DigitInputShortcut: Defaults.Serializable {}
...
enum InputShortcutFormatting {
    static let digitByKeyCode: [UInt16: Int] = InputShortcut.digitByKeyCode
